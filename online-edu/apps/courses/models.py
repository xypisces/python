...
class Course(models.Model):
    ...
    alldesc = models.CharField(max_length=300, verbose_name=u"课程公告", default='')
    ...
    learned_times = models.IntegerField(default=0, verbose_name=u"学习时长(分钟数)")
    ...
    def go_to(self):
        ...
        return mark_safe("<a href='http://www.github.com/xypisces'>跳转</a>")
...
class Video(models.Model):
    ...
    learned_times = models.CharField(max_length=100, verbose_name=u"学习时长(分钟数)")
